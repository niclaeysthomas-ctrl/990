...
/* ---------- 1. Inversions & emphase ---------- */
{
  ...
  q: [
    ...
    ["______ as it may sound, the objection still deserves an answer.", ["For odd", "Odd", "Oddly", "As odd it"], 1, "Concession par inversion : adjectif NU en tête + as + sujet + verbe. « For odd as it may sound » est le réflexe francophone — et c'est faux. (« As odd as it may sound » marche, avec les deux as.)"],
    ["Try ______, he could not reproduce the result.", ["as he might", "he might", "that he might", "as he could"], 0, "Moule figé : « Try as he might » = quoi qu'il tente. Verbe + as + sujet + might, sur le modèle de « Much as I admire her »."]
  ]
},
